 ...
 */
	public int calculaResultadoAtaque(int fuerzaAtacante, int armaAtacante, int agilidadAtacante, int resistenciaDefensor){			
		return Math.abs((resistenciaDefensor)-((fuerzaAtacante + armaAtacante)+(int)(0.25*agilidadAtacante)));		
